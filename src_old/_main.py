...
from network import CandleNet, ExperimentalNet, Resnet, DenseNet
...
net = Resnet.get_network(x, block_config,
                         ...
                         is_training=train)
#net = DenseNet.get_network(x, 3, is_training=train)
...
with tf.Session() as sess:
    ...
    if restore:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            raise Exception('No model found to restore')
    ...
    if train:
        ...
        while True:  # epoch <= epochs:
            ...
            while dh.testing:
                ...
                with open('./testing' , mode='w') as f:
                    f.write('id:{}\ny:{}'.format(ids[0], batch_ys[0]))
                    
                np.save('./array', batch_xs[0])
        ...
        while dh.testing:
            ...
            y_hat = sess.run(tf.nn.softmax(net), feed_dict={x: x_in})
